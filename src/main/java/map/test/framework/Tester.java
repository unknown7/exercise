...
public class Tester<C> {
	...
	private void displayHeader() {
		...
		System.err.format(sizeField, "size");
		for (Test<C> test : tests)
			System.err.format(stringField(), test.name);
		System.err.println();
	}
	public void timedTest() {
		displayHeader();
		for (TestParam param : paramList) {
			System.err.format(sizeField, param.size);
			for (Test<C> test : tests) {
				...
				System.err.format(numberField(), timePerRep);
			}
			System.err.println();
		}
	}
